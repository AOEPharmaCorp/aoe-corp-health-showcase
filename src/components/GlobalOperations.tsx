  ...
  return <section className="py-20 text-white bg-blue-800">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg max-w-3xl mx-auto text-gray-100">Strategically positioned across key regions to serve diverse healthcare needs with offices in India &amp; UAE and operations spanning Asia, GCC, West Africa, Eastern EU and the UAE.</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          <Card className="bg-white/10 backdrop-blur-sm border-white/20 shadow-glow">
            <CardContent className="p-8 text-center">
              ...
              <h3 className="text-xl font-bold mb-2 text-gray-100">Regional Offices</h3>
              <p className="text-2xl font-bold mb-1 text-gray-100">2+</p>
          ...
          <Card className="bg-white/10 backdrop-blur-sm border-white/20 shadow-glow">
            <CardContent className="p-8 text-center">
              ...
              <h3 className="text-xl font-bold mb-2 text-gray-100">Market Presence</h3>
              <p className="text-2xl font-bold mb-1 text-gray-100">5
            </p>
          ...
          <Card className="bg-white/10 backdrop-blur-sm border-white/20 shadow-glow">
            <CardContent className="p-8 text-center">
              ...
              <h3 className="text-xl font-bold mb-2 text-gray-100">Healthcare Impact</h3>
              <p className="text-2xl font-bold mb-1 text-gray-100">1M+</p>
          ...
          <Card className="bg-white/10 backdrop-blur-sm border-white/20 shadow-glow">
            <CardContent className="p-8 text-center">
              ...
              <h3 className="text-xl font-bold mb-2 text-gray-100">Growth</h3>
              <p className="text-2xl font-bold mb-1 text-gray-100">2018</p>
