      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid lg:grid-cols-3 gap-12 mb-12">
          <div className="space-y-6">
            ...
            <p className="max-w-md leading-relaxed text-muted-foreground">Leading provider of high-quality, affordable healthcare solutions globally. Enhancing quality of life through innovative pharmaceutical products since 2018.</p>
