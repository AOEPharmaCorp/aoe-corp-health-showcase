            ...
            <div className="max-w-4xl mx-auto">
              <div className="grid md:grid-cols-4 gap-8">
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground">Apply online with your resume and cover letter</p>
                </div>
                <div className="text-center">
                  <div className="w-16 h-16 bg-primary rounded-full flex items-center justify-center text-white font-bold text-xl mx-auto mb-4">
                    2
                  ...
                  <p className="text-sm text-muted-foreground">HR team reviews your qualifications and experience</p>
                </div>
                <div className="text-center">
                  <div className="w-16 h-16 bg-primary rounded-full flex items-center justify-center text-white font-bold text-xl mx-auto mb-4">
                    3
                  ...
                  <p className="text-sm text-muted-foreground">Multiple rounds with hiring managers and team members</p>
                </div>
                <div className="text-center">
                  <div className="w-16 h-16 bg-primary rounded-full flex items-center justify-center text-white font-bold text-xl mx-auto mb-4">
                    4
                  ...
                  <p className="text-sm text-muted-foreground">Onboarding and integration into your new team</p>
                </div>
              </div>
            </div>
          </div>
